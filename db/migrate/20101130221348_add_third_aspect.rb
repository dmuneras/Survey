...
class AddThirdAspect < ActiveRecord::Migration
  def self.up
    ...
    Question.create(:number => 7,
                    ...
                    :description => %{A continuación se encuentran 5 enunciados con respecto al desarrollo de competencias individuales para el proceso de diseño y desarrollo de productos; seleccione el que mejor describa la situación actual de su empresa},
                    :category => 'unique')
    ...
    descs << %{La empresa se preocupa por el desarrollo de competencias individuales, además se destina tiempo laboral, recursos y dinero para este fin}
    descs << %{La empresa se preocupa por el desarrollo de competencias individuales; se destina tiempo laboral, recursos y dinero para este fin. Además existen reglas de juego establecidas para el desarrollo de competencias}
